  ...
  return <main class="water-demo" data-gosx-scene3d-control-scope="true" data-gosx-scene3d-panel-scope="true" aria-label="GoSX water simulation demo">
    ...
    >
      ...
      <WaterSystem
        ...
        seedVertexGLSL={data.waterSeedVertexGLSL}
        seedFragmentGLSL={data.waterSeedFragmentGLSL}
        seedVertexGLES={data.waterSeedVertexGLES}
        seedFragmentGLES={data.waterSeedFragmentGLES}
        dropVertexGLSL={data.waterDropVertexGLSL}
        dropFragmentGLSL={data.waterDropFragmentGLSL}
        dropVertexGLES={data.waterDropVertexGLES}
        dropFragmentGLES={data.waterDropFragmentGLES}
        displacementVertexGLSL={data.waterDisplacementVertexGLSL}
        displacementFragmentGLSL={data.waterDisplacementFragmentGLSL}
        displacementVertexGLES={data.waterDisplacementVertexGLES}
        displacementFragmentGLES={data.waterDisplacementFragmentGLES}
        simulationVertexGLSL={data.waterSimulationVertexGLSL}
        simulationFragmentGLSL={data.waterSimulationFragmentGLSL}
        simulationVertexGLES={data.waterSimulationVertexGLES}
        simulationFragmentGLES={data.waterSimulationFragmentGLES}
        normalVertexGLSL={data.waterNormalVertexGLSL}
        normalFragmentGLSL={data.waterNormalFragmentGLSL}
        normalVertexGLES={data.waterNormalVertexGLES}
        normalFragmentGLES={data.waterNormalFragmentGLES}
        causticsVertexGLSL={data.waterCausticsVertexGLSL}
        causticsFragmentGLSL={data.waterCausticsFragmentGLSL}
        causticsVertexGLES={data.waterCausticsVertexGLES}
        causticsFragmentGLES={data.waterCausticsFragmentGLES}
        poolVertexGLSL={data.waterPoolVertexGLSL}
        poolFragmentGLSL={data.waterPoolFragmentGLSL}
        poolVertexGLES={data.waterPoolVertexGLES}
        poolFragmentGLES={data.waterPoolFragmentGLES}
        surfaceVertexGLSL={data.waterSurfaceVertexGLSL}
        surfaceFragmentGLSL={data.waterSurfaceFragmentGLSL}
        surfaceVertexGLES={data.waterSurfaceVertexGLES}
        surfaceFragmentGLES={data.waterSurfaceFragmentGLES}
        surfaceBelowVertexGLSL={data.waterSurfaceBelowVertexGLSL}
        surfaceBelowFragmentGLSL={data.waterSurfaceBelowFragmentGLSL}
        surfaceBelowVertexGLES={data.waterSurfaceBelowVertexGLES}
        surfaceBelowFragmentGLES={data.waterSurfaceBelowFragmentGLES}
        objectShadowVertexGLSL={data.waterObjectShadowVertexGLSL}
        objectShadowFragmentGLSL={data.waterObjectShadowFragmentGLSL}
        objectShadowVertexGLES={data.waterObjectShadowVertexGLES}
        objectShadowFragmentGLES={data.waterObjectShadowFragmentGLES}
        compoundShadowVertexGLSL={data.waterCompoundShadowVertexGLSL}
        compoundShadowFragmentGLSL={data.waterCompoundShadowFragmentGLSL}
        ...
        objectMeshShadowVertexGLSL={data.waterObjectMeshShadowVertexGLSL}
        objectMeshShadowFragmentGLSL={data.waterObjectMeshShadowFragmentGLSL}
        ...
        objectMaterialVertexGLSL={data.waterObjectPassVertexGLSL}
        objectMaterialFragmentGLSL={data.waterObjectPassFragmentGLSL}
        objectMaterialVertexGLES={data.waterObjectPassVertexGLES}
        objectMaterialFragmentGLES={data.waterObjectPassFragmentGLES}
        duckMaterialVertexGLSL={data.waterDuckPassVertexGLSL}
        duckMaterialFragmentGLSL={data.waterDuckPassFragmentGLSL}
