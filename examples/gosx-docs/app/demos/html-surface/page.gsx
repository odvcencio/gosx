...
func Page() Node {
	...
	>
		...
		<div class="html-surface__overlay">
			<p class="html-surface__eyebrow">Real HTML. Real CSS. On a surface in the scene.</p>
			<h1 class="html-surface__title">Diegetic panels</h1>
			<p class="html-surface__tagline">
				Each panel is a quad in the scene graph whose texture is the page's own markup, laid out by the browser and rasterized at device resolution. Orbit the scene: the panels rotate with it, occlude behind geometry, and stay legible off-axis.
			</p>
			<details class="html-surface__proof">
				<summary>How this differs from a DOM overlay</summary>
				<ul>
					<li>
