...
func Page() Node {
    return <section class="fluid" aria-label="Server-streamed velocity field">
        <div class="fluid__frame">
            ...
            <div class="fluid__hud" aria-live="polite">
                ...
                <div class="fluid__stat">
                    ...
                    <b class="fluid__stat-value" id="fluid-grid">{data.gridN}³</b>
                </div>
                <div class="fluid__stat">
        ...
        <footer class="fluid__footer">
            <span>server advects a 16³ vec3 velocity field at 20 Hz · deltas quantized to 6 bits · particles ride the decoded slice client-side</span>
        </footer>
