	...
	return scene.Props{
		...
		Graph: scene.NewGraph(
			...
			scene.Mesh{
				...
				Position:      scene.Vec3(5.0, 0.9, -1.5),
			...
			scene.Mesh{
				...
				Position:      scene.Vec3(0.8, 0.45, 2.2),
