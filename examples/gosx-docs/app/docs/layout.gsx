				...
				<article class="docs-content prose">
					...
					<footer class="docs-footer">
						<If cond={data.prev != nil}>
							<a href={data.prev.href} data-gosx-link="true" class="docs-footer__link docs-footer__link--prev">
								{data.prev.label}
							</a>
						</If>
						<If cond={data.next != nil}>
							<a href={data.next.href} data-gosx-link="true" class="docs-footer__link docs-footer__link--next">
								{data.next.label}
							</a>
						</If>
					</footer>
