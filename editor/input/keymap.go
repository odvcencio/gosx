...
var DefaultKeymap = Keymap{
	...
	"Tab":                 CmdIndent,
	"Shift-Tab":           CmdDedent,
	"Mod-/":               CmdToggleComment,
	"Mod-Shift-\\":        CmdMatchBracket,
	"Mod-Alt-ArrowUp":     CmdAddCursorUp,
	"Mod-Alt-ArrowDown":   CmdAddCursorDown,
	"Alt-Shift-ArrowUp":   CmdBlockSelectUp,
	"Alt-Shift-ArrowDown": CmdBlockSelectDown,
	"Mod-F":               CmdFind,
	"Mod-H":               CmdReplace,
	"Enter":               CmdNewline,
	"Escape":              CmdEscape,
