...
// other two wire kinds -- transform+color, and skinned pose for an
// InstancedGLBMesh crowd -- are reserved: applying them needs to cooperate
// with the retained model-instance pose tracker's membership bookkeeping
// instead of writing a flat array, so they ship separately. A frame carrying
// either kind fails named (console.error plus a
