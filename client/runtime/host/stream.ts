// stream.ts — browser-host streamed-template consumption.
//
 ...
 * @property {Element|null} [parentNode]
 * @property {HTMLTemplateElement['content']} [content]
...
(function () {
  ...
  /** @param {GoSXStreamTemplate|null} template */
  ...
  /** @param {Element|null} target @param {Node} content */
