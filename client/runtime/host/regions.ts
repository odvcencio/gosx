...
//
// The builder concatenates this typed host source into the base/runtime
// bundles. It remains a script so the browser-host globals stay compatible
// with the existing bootstrap lifecycle.

/**
 * @typedef {object} GoSXRegionRecord
 * @property {Element} element
 * @property {string} field
 * @property {string|null} signalName
 * @property {string[]} onEvents
 * @property {object|null} transport
 * @property {AbortController|null} requestController
 * @property {Function|null} unsubscribe
 * @property {Function|null} hubListener
