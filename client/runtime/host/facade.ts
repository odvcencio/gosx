// @ts-check
// GoSX browser host: generic managed surfaces and the typed runtime facade.
//
 ...
 * @property {Function} requestLatest
 * @property {Function} cancelRequest
 * @property {Function} json
 * @property {Function} requestJSON
 ...
 * @property {object|null} namespace
 * @property {object|null} dom
 * @property {GoSXTransportScope|null} transport
 * @property {Function|null} fetch
 * @property {Function} request
 * @property {Function} requestLatest
 * @property {Function} cancelRequest
 * @property {Function} requestJSON
 * @property {Function} navigate
 * @property {Function} reconcile
 * @property {Function} reportFailure
 * @property {AbortSignal|null} signal
 * @property {Function} listen
 * @property {Function} query
 * @property {Function} queryAll
 * @property {Function} contains
 * @property {Function} dispatch
 * @property {Function} abort
 */

/** @typedef {(context: GoSXRuntimeSurfaceContext) => unknown} GoSXRuntimeSurfaceFactory */
(function () {
  "use strict";
