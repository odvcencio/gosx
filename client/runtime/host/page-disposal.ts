// @ts-check
// GoSX browser host: page disposal and persistent scene engines across soft navigations.
//
...
/**
 * @typedef {object} GoSXPageManifest
 ...
 */
  ...
  // --------------------------------------------------------------------------
  //
  // Soft navigation (server/navigation.ts) used to dispose EVERY
