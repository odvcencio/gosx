// @ts-check
// GoSX browser host: one core lifecycle for replacing server-rendered HTML.
//
 ...
 * @property {Node|Document|Element} root
 * @property {AbortSignal|null} signal
 * @property {Function} listen
 * @property {Function} on
 * @property {(selector: string) => Element|null} query
 * @property {(selector: string) => Element[]} queryAll
 * @property {(node: Node) => boolean} contains
 * @property {(node: Node, options?: object) => Function} own
 * @property {(node: Node, options?: object) => Function} portal
 * @property {(type: string, detail?: unknown) => void} dispatch
