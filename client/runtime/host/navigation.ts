// navigation.ts — browser-host page navigation runtime.
// @ts-check

/**
 * @typedef {"idle"|"pending"} GoSXNavigationPhase
 * @typedef {object} GoSXNavigationState
 * @property {GoSXNavigationPhase} phase
 * @property {string} currentURL
 * @property {string} pendingURL
 *
 * @typedef {object} GoSXNavigationOptions
 * @property {boolean} [replace]
 * @property {boolean} [preserveScroll]
 * @property {Element} [sourceLink]
 *
 * @typedef {object} GoSXNavigationAPI
 * @property {(url: string|URL, options?: GoSXNavigationOptions) => Promise<boolean>} navigate
 * @property {(form: HTMLFormElement, submitter?: HTMLElement|null) => Promise<unknown>} submitAction
 * @property {() => GoSXNavigationState} getState
 * @property {() => GoSXNavigationState} refresh
 */
...
(function() {
  ...
  const navigationBeaconLastPath = new Map();
