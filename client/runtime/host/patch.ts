...
(function () {
   ...
   */
  function applyPatchesJSON(islandID, patchOpsJSON) {
    var ops;
    try {
   ...
   */
  function applyPatchMailbox(islandID, mailbox) {
    try {
  ...
  function decodePatchMailbox(input) {
    ...
    throw new Error("runtime mailbox codec is unavailable");
  }
  ...
  gosxHost.patch = Object.assign(gosxHost.patch || {}, {
    apply: applyPatchOperations,
