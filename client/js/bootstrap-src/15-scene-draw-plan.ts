   ...
   * @property {Float32Array} staticOpaqueColors
   * @property {Float32Array} staticOpaqueMaterials
   * @property {Float32Array} dynamicOpaquePositions
   * @property {Float32Array} dynamicOpaqueColors
   * @property {Float32Array} dynamicOpaqueMaterials
   * @property {number} staticOpaqueVertexCount
   * @property {number} dynamicOpaqueVertexCount
   * @property {number} alphaVertexCount
   * @property {number} additiveVertexCount
   * @property {boolean} hasAlphaPass
   * @property {boolean} hasAdditivePass
   */
