   ...
   * @property {number|string} emissive
   * @property {number|string} roughness
   * @property {number|string} metalness
   * @property {Array<number>|null} shaderData
   */
  ...
  // clamp01 is defined in 11-scene-math.ts (shared across all modules).
