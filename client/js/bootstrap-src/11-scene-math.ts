  ...
  /** @typedef {{kind?: string, x?: number, y?: number, z?: number, rotationX?: number, rotationY?: number, rotationZ?: number, fov?: number, near?: number, far?: number, zoom?: number, left?: number, right?: number, top?: number, bottom?: number}} SceneCamera */
  /** @typedef {{origin: ScenePoint, dir: ScenePoint}} SceneRay */
  /** @typedef {{distance: number, x: number, y: number, z: number}} SceneHit */
