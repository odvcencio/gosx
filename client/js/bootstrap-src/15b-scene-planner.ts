   ...
   * @property {number} fullVertexHashScans
   * @property {number} retainedHashFastPaths
   * @property {number} plannerCPUms
   * @property {number} lastPlannerCPUms
   */
   ...
   * @property {Array} pbrPasses
   * @property {object|null} worldDrawPlan
   * @property {object} worldDrawScratch
   * @property {Map} caches
   * @property {string} shadowPassHash
   * @property {string} materialsHash
   * @property {object} resolvedEnv
   * @property {boolean} cssDynamic
   * @property {object|null} cssCache
   * @property {number} rebuilds
   * @property {ScenePlannerTelemetry} telemetry
   */
