...
// Alpha-masked mesh materials. These tests execute the actual production
// fragments inside a VM; they do not reimplement the production algorithms.
// They cover normalization, glTF extraction, opaque/depth routing, overrides,
// and the zero-opacity visibility gates; renderer shader behavior is covered
// by the focused material-render tests.
...
test("MASK materials map to the opaque pass and never mutate the source doc", () => {
  ...
  // MASK stays out of the blended alpha pass on every primitive class.
