(function() {
  ...
  const SCENE_PBR_FRAGMENT_SOURCE = [
    ...
    "        float shadow = 1.0;",
    "        if (u_receiveShadow != 0 && lightType == 1) {",
    "            if (u_hasShadow0 != 0 && i == u_shadowLightIndex0) {",
    "                shadow = shadowFactor(u_shadowMap0, u_lightSpaceMatrix0, u_shadowBias0);",
    "            } else if (u_hasShadow1 != 0 && i == u_shadowLightIndex1) {",
