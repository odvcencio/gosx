			...
			"scene": scene.Props{
				...
				Graph: scene.NewGraph(
					scene.DirectionalLight{
						...
						Color:     "#fff1d6",
						Intensity: 1.2,
						Direction: scene.Vec3(0.4, -1, -0.3),
					},
					scene.Model{
						ID:       "runner",
						Src:      "/models/runner.gosx3d.json",
						Position: scene.Vec3(1.2, 0.1, -0.6),
						Scale:    scene.Vec3(1.4, 1.1, 1.2),
						Material: scene.GlowMaterial{
							Color:      "#ffd48f",
							Opacity:    scene.Float(0.74),
							Emissive:   scene.Float(0.22),
					...
					scene.Sprite{
						Target:     "runner",
						Src:        "/paper-card.png",
						Position:   scene.Vec3(0.08, 1.05, 0.24),
						Width:      1.55,
						Height:     1.02,
						Scale:      1,
						Opacity:    0.94,
					...
					scene.Mesh{
						...
						Material: scene.FlatMaterial{Color: "#d6ee82"},
						Position: scene.Vec3(-1.8, 0.4, 0.3),
	...
	ctx := &RouteContext{
		Data: map[string]any{
			"scene": scene.Props{
				...
				Camera: scene.PerspectiveCamera{
					Position: scene.Vec3(0, 0.4, 6),
					Rotation: scene.Rotate(0.18, -0.3, 0),
					FOV:      62,
					Near:     0.15,
					Far:      64,
				},
