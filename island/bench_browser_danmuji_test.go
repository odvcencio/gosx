...
//
// Run:   go test -tags e2e ./island/ -run TestBrowser -v
...
//line island/bench_browser.dmj:16
	...
	t.Run("a running GoSX page", func(t *testing.T) {
		...
		t.Run("profiling page load", func(t *testing.T) {
			...
			//line island/bench_browser.dmj:28
...
//line island/bench_browser.dmj:37
	...
	t.Run("a page with a counter island", func(t *testing.T) {
		...
		t.Run("clicking increment", func(t *testing.T) {
			...
			//line island/bench_browser.dmj:49
...
//line island/bench_browser.dmj:58
	t.Parallel()
	//line island/bench_browser.dmj:59
	t.Run("a page with Scene3D", func(t *testing.T) {
		//line island/bench_browser.dmj:60
