...
func writeFixtureInventory(t *testing.T, root string, source SourceIdentity, includedLines int, includedBytes int64, nameMutator func([]string) []string) SourceIdentity {
	...
	inv := Inventory{
		...
		Totals:        Totals{IncludedFiles: 1, IncludedJavaScriptLines: includedLines, IncludedBytes: includedBytes, IncludedGzipBytes: 10, IncludedBrotliBytes: 10, ByExtension: map[string]int{".js": 1}},
