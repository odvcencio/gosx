...
var (
	...
	blankLineSplitRe = regexp.MustCompile(`\r?\n`)
...
func DefaultCorpusManifest() CorpusManifest {
	return CorpusManifest{
		...
		FixtureRoutes: []FixtureRoute{
			...
			{ID: "R09A", Route: "/navigation/a", FixtureApp: "examples/ouroboros-corpus", Purpose: "client navigation entry route", ExpectedRuntime: "navigation", ExpectedTinyGoCurrent: "islands", ExpectedTinyGoFuture: "core", Capabilities: []string{"navigation", "dispose"}},
			{ID: "R09B", Route: "/navigation/b", FixtureApp: "examples/ouroboros-corpus", Purpose: "client navigation target route", ExpectedRuntime: "navigation", ExpectedTinyGoCurrent: "islands", ExpectedTinyGoFuture: "core", Capabilities: []string{"navigation", "dispose"}},
		...
		Variants: []RuntimeVariant{
			...
			{ID: "islands", Generation: "current", Status: "measured", SizeArtifact: variantArtifact("sizes/islands.json"), WASMArtifact: variantArtifact("wasm/islands.wasm"), SelectedByRoutes: []string{"R02", "R03", "R09A", "R09B"}},
...
func collectTextEvidence(rel, text string, inv *Inventory) {
	lines := blankLineSplitRe.Split(text, -1)
...
func scanCompatibilityNameSetFromFiles(files []SourceFile, read func(SourceFile) ([]byte, error), identity CompatibilitySourceIdentity) (CompatibilityNameSetEvidence, error) {
	...
	for _, src := range files {
		...
		for index, line := range blankLineSplitRe.Split(string(body), -1) {
